...
func Login(w http.ResponseWriter, r *http.Request) {
	w.Header().Add("content-type", "application/json") // indico que se va a enviar datos en json
	...
	if err != nil {
		http.Error(w, "Error al generar el Token correspondiente"+err.Error(), 400)
		return
	}
